...
function greeter(firstName, state){
	console.log.greeter(`Hello! My name is Connor and I live in Texas`)
}
//////////////////PROBLEM 12////////////////////
...
// First, use .map to create a new array that doubles each number. Call the new array 'doubled'.
 let doubled = myNumbers.map(function (n) { return n * 2; })
// Code Here
...
// Code Here
let filtered = [3, 55, 788, 2, 1].filter((number)=> number > 100)
//////////////////PROBLEM 16////////////////////
...
// Code Here
const total = myNumbers.reduce((total, amount) => total + amount)
//////////////////PROBLEM 17////////////////////
...
// Code Here
let totallyAwesome = people.reduce((total, awesomeLevel) => total + awesomeLevel)