...
let me = {
    firsName: 'Connor',
    superHeroName: 'electrode toe',
    homeTown: 'East Lansing'
    superPowers: ['electride slide', 'static shock', 'charged up jump'],
...
// CODE HERE
let regularName = 'Connor'
let superName = 'electrode toe'
let homeTown = 'East Lansing'
